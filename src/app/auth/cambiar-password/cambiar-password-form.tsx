...
import { cambiarPasswordObligatorioAction, type CambiarPasswordState } from "./actions";
import { Eye, EyeOff } from "lucide-react";

export function CambiarPasswordForm() {
  const [state, action, pending] = useActionState<CambiarPasswordState, FormData>(
    cambiarPasswordObligatorioAction,
    null,
  );
  ...
  return (
    <form action={action} className="space-y-5">
      <div className="space-y-1.5">
        ...
        <p className="text-[12px] text-neutral-400">Mínimo 8 caracteres.</p>
      </div>
