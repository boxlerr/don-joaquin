            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <Dialog.Description className="text-[#475569] text-xs mt-0.5">
                  Paso a paso visual para cargar camiones y mantenerlos al día.
                </Dialog.Description>
              </div>
            </div>
            <Dialog.Close
    ...
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <div
        className={
          ...
          (highlight === "import"
            ? "bg-white border-2 border-[#0088D1] text-[#0088D1] shadow-[0_0_0_3px_rgba(0,136,209,0.15)]"
  ...
  return (
    <div className="bg-white border border-[#E2E8F0] rounded-md shadow-sm w-full max-w-[420px] mx-auto">
      <div className="px-3 py-2 border-b border-[#E2E8F0]">
        <div className="text-[#0F172A] text-xs font-semibold">Agregar nuevo camión</div>
      </div>
...
function MockImportPreview() {
  ...
  return (
    <div className="bg-white border border-[#E2E8F0] rounded-md overflow-hidden">
      <div className="px-3 py-2 border-b border-[#E2E8F0] flex items-center gap-3 text-[11px]">
        <span className="text-[#047857] font-semibold">2 válidas</span>
        <span className="text-[#475569]">·</span>
        <span className="text-red-600 font-semibold">2 con error</span>
        <span className="text-[#475569]">· Se importarán 2 registros.</span>
      </div>
