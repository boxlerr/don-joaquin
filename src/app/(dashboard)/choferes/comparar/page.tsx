...
function buildMetrics(a: RankingChofer, b: RankingChofer): Metric[] {
  ...
  return [
    ...
    { label: "Apercibimientos", a: a.apercibimientos_total, b: b.apercibimientos_total, format: fInt, direction: "lower_better", indent: true },
    { label: "Leves", a: a.apercibimientos_leves, b: b.apercibimientos_leves, format: fInt, direction: "lower_better", indent: true },
    { label: "Moderados", a: a.apercibimientos_moderados, b: b.apercibimientos_moderados, format: fInt, direction: "lower_better", indent: true },
    { label: "Graves", a: a.apercibimientos_graves, b: b.apercibimientos_graves, format: fInt, direction: "lower_better", indent: true },
