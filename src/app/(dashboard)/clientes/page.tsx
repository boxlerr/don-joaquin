  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <StatCard label="Total clientes" value="—" color="brand" />
        <StatCard label="Activos" value="—" color="success" />
        <StatCard label="Con deuda" value="—" color="error" />
      </div>
      ...
      <div className="bg-white rounded-[8px] border border-[#E2E8F0] shadow-sm">
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#E2E8F0]">
          ...
          <Input type="search" placeholder="Buscar cliente..." className="w-56 text-sm" />
        </div>
        <Table>
          <TableHeader className="bg-[#F8FAFC]">
            <TableRow>
              {["Razón social", "CUIT", "Contacto", "Teléfono", "Localidad", "Saldo", "Acciones"].map((col) => (
                <TableHead
                  key={col}
