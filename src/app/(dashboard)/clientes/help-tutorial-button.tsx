            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <Dialog.Description className="text-[#475569] text-xs mt-0.5">
                  Paso a paso visual para cargar tu cartera.
                </Dialog.Description>
              </div>
            </div>
            <Dialog.Close
...
function MockToolbar({ highlight }: { highlight: "new" | "import" }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="size-9 rounded-md border border-[#0088D1] bg-white text-[#0088D1] inline-flex items-center justify-center">
        <HelpCircle size={14} />
      </div>
      <div
        className={
  ...
  return (
    <div className="bg-white border border-[#E2E8F0] rounded-md shadow-sm w-full max-w-[420px] mx-auto">
      <div className="px-3 py-2 border-b border-[#E2E8F0]">
        <div className="text-[#0F172A] text-xs font-semibold">Nuevo cliente</div>
      </div>
